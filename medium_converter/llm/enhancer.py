...
async def enhance_article(article: Article, config: Optional[LLMConfig] = None) -> Article:
            ...
            for block_index, block in enumerate(item.blocks):
                if block.type.value == "text":
                    ...
                    try:
                        ...
                        enhanced_article.content[item_index].blocks[block_index].content = enhanced_text
